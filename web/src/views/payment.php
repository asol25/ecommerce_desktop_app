...
<div class="table-responsive payment">
    <div class="container_payment">
        <form action="/vnpay_php/vnpay_create_payment" id="create_form" method="post">
            <div class="d-none">
                ...
                <div class="form-group ">
                    ...
                    <select name="order_type" id="order_type" class="form-control">
                        <option value="topup">Thanh Toan Courses</option>
            ...
            <button type="submit" class="btn btn-primary" id="btnPopup">Payment</button>
        </form>
    </div>
</div>

<script src<?php include_once \app\core\Application::$ROOT_DIR . "/web/src/assets/css/payment/jquery-1.11.3.min.js" ?>></script>