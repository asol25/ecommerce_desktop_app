...
<main class="main">
    ...
    <?php include_once \app\core\Application::$ROOT_DIR . "/web/src/views/components/_Products.php"?>
    <!--==================== STORY ====================-->
    <!-- <section class="story section container">
        <div class="story__container grid">
            ...
            <div class="story__images">
                <img src="/src/assets/img/story.png" alt="" class="story__img">
    ...
    <!--==================== TESTIMONIAL ====================-->
    <!-- <section class="testimonial section container active-link">
        <div class="testimonial__container grid">
                ...
                <div class="swiper-wrapper">
                    <div class="testimonial__card swiper-slide">
                        ...
                        <div class="testimonial__perfil">
                            <img src="/src/assets/img/testimonial1.jpg" alt="" class="testimonial__perfil-img">
                            <div class="testimonial__perfil-data">
                                <span class="testimonial__perfil-name">Lee
                                    Doe</span>
                                <span class="testimonial__perfil-detail">Director
                                    of a company</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="testimonial__card swiper-slide">
                        ...
                        <h3 class="testimonial__date">March 27. 2021</h3>
                        <div class="testimonial__perfil">
                            <img src="/src/assets/img/testimonial2.jpg" alt="" class="testimonial__perfil-img">
                            <div class="testimonial__perfil-data">
                    ...
                    <div class="testimonial__card swiper-slide">
                        ...
                        <h3 class="testimonial__date">March 27. 2021</h3>
                        <div class="testimonial__perfil">
                            <img src="/src/assets/img/testimonial3.jpg" alt="" class="testimonial__perfil-img">
                            <div class="testimonial__perfil-data">
            ...
            <div class="testimonial__images">
                ...
                <img src="/src/assets/img/testimonial.png" alt="" class="testimonial__img">
            </div>
        </div>
    </section> -->

    <!--==================== NEW ====================-->
    <!-- <section class="new section container active-link" id="new">
            ...
            <div class="swiper new-swiper">
                <div class="swiper-wrapper">
                    <article class="new__card swiper-slide">
                        ...
                        <img src="/src/assets/img/new1.png" alt="" class="new__img">
                    ...
                    <article class="new__card swiper-slide">
                        ...
                        <img src="/src/assets/img/new2.png" alt="" class="new__img">
                    ...
                    <article class="new__card swiper-slide">
                        ...
                        <img src="/src/assets/img/new3.png" alt="" class="new__img">
                    ...
                    <article class="new__card swiper-slide">
                        ...
                        <img src="/src/assets/img/new4.png" alt="" class="new__img">
