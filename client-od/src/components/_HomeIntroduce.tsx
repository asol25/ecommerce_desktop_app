            ...
            <section className="home" id="home">
                <div className="home__container container grid">
                    ...
                    <div className="home__social">
                        {social.map((node) => {
                            return (
                                <a key={node} href={`https://www.${node.toLowerCase()}.com/`} target="_blank" className="home__social-link">
                                    {node}
                                </a>
                            )
                        })}
                    ...
                    <div className="home__data">
                        ...
                        <div className="home__btns">
                            <a href="#" className="button button--gray button--small">{btn[0]}</a>

                            <button className="button home__button">{btn[1]}</button>
                        </div>
                    </div>
                </div>
            </section>
